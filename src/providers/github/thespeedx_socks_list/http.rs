...
#[derive(Debug, Clone)]
pub struct GithubTheSpeedXProxyListHttpProvider {
    pub base: BaseProvider,
    pub url: String,
    pub pattern: String,
}

impl GithubTheSpeedXProxyListHttpProvider {
...
impl Default for GithubTheSpeedXProxyListHttpProvider {
    fn default() -> Self {
        Self {
            base: BaseProvider {
                proto: vec_of_strings!["HTTP", "HTTPS", "SOCKS4", "SOCKS5"],
                domain: "TheSpeedX/SOCKS-List/http".to_string(),
                ..Default::default()
            },
